...
def user_appraisal_display():
    ...
    red = Response.query.filter(Response.user_id == current_user.id, Response.date_posted == request.args['date']).join(Comments, Comments.user_id == Response.user_id and Comments.date_posted == Response.date_posted and Comments.questionnaire_id == Response.questionnaire_id and Comments.section_id == Response.section_id and Comments.question_id == Response.question_id).outerjoin(Evidence, Evidence.user_id == Response.user_id, Evidence.date_posted == Response.date_posted, Evidence.questionnaire_id == Response.questionnaire_id, Evidence.section_id == Response.section_id, Evidence.question_id ==Response.question_id).outerjoin(Action, Action.user_id == Response.user_id, Action.date_posted == Response.date_posted, Action.questionnaire_id == Response.questionnaire_id, Action.section_id == Response.section_id, Action.question_id == Response.question_id).order_by(asc(Response.section_id), asc(Response.question_id))
