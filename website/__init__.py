...
def create_app():
    ...
    if 'subscription' not in table_names:
        ...
        inquestions = Questions(title = "1.1 Aware of and complies with current legislation relevant to the role",id =1, section_id = 1, questionnaire_id =1)
        db.session.add(inquestions)
        db.session.commit()
        inquestions2 = Questions(title = "1.2 Aware of and complies with organisation requirements", section_id = 1, questionnaire_id =1, id =2)
        db.session.add(inquestions2)
        db.session.commit()
        inquestions3 = Questions(title = "1.3 Relevant professional learning completed", section_id = 1, questionnaire_id =1, id =3)
        db.session.add(inquestions3)
        db.session.commit()
        inquestions4 = Questions(title = "1.4 Aware of and complies with organisation requirements", section_id = 1, questionnaire_id =1, id =4)
        db.session.add(inquestions4)
        db.session.commit()
        #Isert questions for section 2
        inquestions5 = Questions(title = "2.1 Aware of and complies with current legislation relevant to the role", section_id = 2, questionnaire_id =1, id =5)
        db.session.add(inquestions5)
        db.session.commit()
        inquestions6 = Questions(title = "2.2 Aware of and complies with organisation requirements", section_id = 2, questionnaire_id =1, id =6)
        db.session.add(inquestions6)
        db.session.commit()
        inquestions7 = Questions(title = "2.3 Relevant professional learning completed", section_id = 2, questionnaire_id =1, id =7)
        db.session.add(inquestions7)
        db.session.commit()
        inquestions8 = Questions(title = "2.4 Aware of and complies with organisation requirements", section_id = 2, questionnaire_id =1, id =8)
        db.session.add(inquestions8)
        db.session.commit()
        inquestions9 = Questions(title = "2.5 Aware of and complies with organisation requirements", section_id = 2, questionnaire_id =1, id =9)
        db.session.add(inquestions9)
        db.session.commit()
        #Insert questions for section 3
        inquestions10 = Questions(title = "3.1 Aware of and complies with current legislation relevant to the role", section_id = 3, questionnaire_id =1, id =10)
        db.session.add(inquestions10)
        db.session.commit()
        inquestions11 = Questions(title = "3.2 Aware of and complies with organisation requirements", section_id = 3, questionnaire_id =1, id =11)
        db.session.add(inquestions11)
        db.session.commit()
        inquestions12 = Questions(title = "3.3 Relevant professional learning completed", section_id = 3, questionnaire_id =1, id =12)
        db.session.add(inquestions12)
        db.session.commit()
        #Insert Questions for section 4
        inquestions13 = Questions(title = "4.1 Aware of and complies with current legislation relevant to the role", section_id = 4, questionnaire_id =1, id =13)
        db.session.add(inquestions13)
        db.session.commit()
        inquestions14 = Questions(title = "4.2 Aware of and complies with organisation requirements", section_id = 4, questionnaire_id =1, id =14)
        ...
        db.session.commit()
        indotpoints5 = Dotpoints(sequence_id = 5, question_id = 5, questionnaire_id =1, section_id = 2, title = "Very")
        db.session.add(indotpoints5)
        db.session.commit()
        indotpoints6 = Dotpoints(sequence_id = 6, question_id = 6, questionnaire_id = 1, section_id =2 ,title = "Very")
        db.session.add(indotpoints6)
        db.session.commit()
        indotpoints7 = Dotpoints(sequence_id = 7, question_id = 7, questionnaire_id = 1, section_id =2, title = "Very")
        db.session.add(indotpoints7)
        db.session.commit()
        indotpoints8 = Dotpoints(sequence_id = 8, question_id =8, questionnaire_id = 1, section_id = 2, title = "Very")
        db.session.add(indotpoints8)
        db.session.commit()
        indotpoints9 = Dotpoints(sequence_id = 9, question_id = 9, questionnaire_id =1, section_id =2,  title = "Very")
        db.session.add(indotpoints9)
        db.session.commit()
        indotpoints10 = Dotpoints(sequence_id = 10, question_id = 10, questionnaire_id = 1, section_id = 3, title = "Very")
        db.session.add(indotpoints10)
        db.session.commit()
        indotpoints11 = Dotpoints(sequence_id = 11, question_id = 11, questionnaire_id = 1, section_id = 3, title = "Very")
        db.session.add(indotpoints11)
        db.session.commit()
        indotpoints12 = Dotpoints(sequence_id = 12, question_id = 12, questionnaire_id = 1, section_id = 3, title = "Very")
        db.session.add(indotpoints12)
        db.session.commit()
        indotpoints13 = Dotpoints(sequence_id = 13, question_id = 13, questionnaire_id = 1, section_id = 4, title = "Very")
        db.session.add(indotpoints13)
        db.session.commit()
        indotpoints14 = Dotpoints(sequence_id = 14, question_id = 14, questionnaire_id = 1, section_id = 4, title = "Very")
