...
def create_app():
    ...
    if 'subscription' not in table_names:
        ...
        db.session.commit()
        inquestions4 = Questions(title = "Aware of and complies with organisation requirements", section_id = 1, questionnaire_id =1, id =4)
        db.session.add(inquestions4)
        db.session.commit()
        #Isert questions for section 2
        inquestions5 = Questions(title = "Aware of and complies with current legislation relevant to the role", section_id = 2, questionnaire_id =1, id =5)
        db.session.add(inquestions5)
        db.session.commit()
        inquestions6 = Questions(title = " Aware of and complies with organisation requirements", section_id = 2, questionnaire_id =1, id =6)
        db.session.add(inquestions6)
        db.session.commit()
        inquestions7 = Questions(title = "Relevant professional learning completed", section_id = 2, questionnaire_id =1, id =7)
        db.session.add(inquestions7)
        db.session.commit()
        inquestions8 = Questions(title = "Aware of and complies with organisation requirements", section_id = 2, questionnaire_id =1, id =8)
        db.session.add(inquestions8)
        db.session.commit()
        inquestions9 = Questions(title = "Aware of and complies with organisation requirements", section_id = 2, questionnaire_id =1, id =9)
        db.session.add(inquestions9)
        db.session.commit()
        #Insert questions for section 3
        inquestions10 = Questions(title = "Aware of and complies with current legislation relevant to the role", section_id = 3, questionnaire_id =1, id =10)
        db.session.add(inquestions10)
        db.session.commit()
        inquestions11 = Questions(title = " Aware of and complies with organisation requirements", section_id = 3, questionnaire_id =1, id =11)
        db.session.add(inquestions11)
        db.session.commit()
        inquestions12 = Questions(title = " Relevant professional learning completed", section_id = 3, questionnaire_id =1, id =12)
        db.session.add(inquestions12)
        db.session.commit()
        #Insert Questions for section 4
        inquestions13 = Questions(title = "Aware of and complies with current legislation relevant to the role", section_id = 4, questionnaire_id =1, id =13)
        db.session.add(inquestions13)
        db.session.commit()
        inquestions14 = Questions(title = "Aware of and complies with organisation requirements", section_id = 4, questionnaire_id =1, id =14)
